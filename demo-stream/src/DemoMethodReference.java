...
public class DemoMethodReference {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(lengthSupplier2.get()); // 4
    ...
    System.out.println(stringToInteger.apply("100")); // 100

    Function<String, Integer> stringToInteger2 = Integer::valueOf;
    System.out.println(stringToInteger2.apply("100")); // 100

    // Lambda
    BiFunction<Integer, String, Student> createStudentFunction = (id, stName) -> new Student(id, stName);
    Student s1 = createStudentFunction.apply(1, "John");
    
    BiFunction<Integer, String, Student> createStudentFunction2 = Student::new;
    Student s2 = createStudentFunction2.apply(1, "Peter");
  }
