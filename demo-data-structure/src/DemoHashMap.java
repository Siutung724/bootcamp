...
public class DemoHashMap {
  public static void main(String[] args) {
    ...
    // For Searching, you just use get() to find target object
    ...
    // ! Hashmap use get() to find target object, while ArrayList use loop to find target objct
    Student leo = studentMap.get("Leo"); // ! risky
    if (leo != null) { // remove risky
      System.out.println("Leo exists..." + leo.getName() + "/" + leo.getScore()) ;
    } else {
      System.out.println("Leo doesn't exit...");
    }
  }
}