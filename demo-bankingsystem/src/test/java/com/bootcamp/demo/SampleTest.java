...
public class SampleTest {
	...
	public void bankCreditTest() {
		...
		assertEquals(23.45, bank.getBalance(ameliaPond), 0); // ! 0.0 + 23.45
		assertEquals(480.23, bank.getBalance(roseTyler), 0); // ! 456.78 + 23.45
		assertEquals(23.45, bank.getBalance(acmeCorp), 0); // ! 0.0 + 23.45
		assertEquals(9876566.66, bank.getBalance(hackerRank), 0); // ! 9876543.21 + 23.45
	}
